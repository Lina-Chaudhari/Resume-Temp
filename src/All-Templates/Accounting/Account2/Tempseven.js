...
class Temp7 extends React. Component {
    state = {
  ...
  <img
    ...
    <div className="contact-container7">
      ...
      <div className="contact-list7">
        ...
        <FontAwesomeIcon icon={faEnvelope} style={{ marginRight: '2px', fontSize: '15px', color: 'white' }} />
        </div>
      ...
      <div className="contact-list7">
        <div className="icon-container7">
        <FontAwesomeIcon icon={faLaptop} style={{ marginRight: '2px', fontSize: '15px', color: 'white' }} />
        </div>
        <div className="contact-text7"  contentEditable="true">
      ...
      <div className="contact-list7">
        <div className="icon-container7">
        <FontAwesomeIcon icon={faLinkedin} style={{ marginRight: '2px', fontSize: '15px', color: 'white' }} />
        </div>
        <div className="contact-text7" contentEditable="true">
